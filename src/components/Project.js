                ...
                <div className="col-4 mb-24">
                    <div className="bg-box-new">
                        <div className="pro-add-new">
                            <h4>Project</h4>
                            <Link to={"/CreateProject"} type="button" className='btn add-new'><i className="fa-solid fa-plus"></i> Add New</Link>
                        </div>
                    ...
                    <div className="bg-box h-auto">
                      ...
                      <div className='row'>
                        ...
                        <div className="text-center mt-4">
                            <Link to={"#"} type="submit" className="btn btn-pro">View quotation</Link>
                        </div>
                      </div>
                    </div>
                </div>
